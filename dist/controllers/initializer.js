...
function create(config) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var START_TIME, waPage, notifier, sessionId, customUserAgent, result, prettyFont, popupaddr, spinner, throwOnError, PAGE_UA, BROWSER_VERSION, WA_AUTOMATE_VERSION, WA_VERSION, canInjectEarly, debugInfo, authRace, authenticated, outOfReach, race, result, pre, VALID_SESSION, localStorage_1, _a, _b, sessionjsonpath, sessionData, sdB64, pureWAPI, _c, LAUNCH_TIME_MS, data, client, me, l_err, data, l_success, error_1;
        var _this = this;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 13:
                    ...
                    authRace = [];
                    authRace.push(auth_1.isAuthenticated(waPage).catch(function (e) { }));
                    if (!(config === null || config === void 0 ? void 0 : config.authTimeout) && (config === null || config === void 0 ? void 0 : config.authTimeout) !== 0) {
                ...
                case 18:
                    ...
                    if (!(config === null || config === void 0 ? void 0 : config.qrTimeout) && (config === null || config === void 0 ? void 0 : config.qrTimeout) !== 0) {
                        ...
                        waPage.on('error', function (error) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        _a.sent();
                                        return [4, create(config).then(config.restartOnCrash)];
                                    case 2:
                                        _a.sent();
                                        return [2];
                                }
                ...
                case 38:
                    ...
                    if (config === null || config === void 0 ? void 0 : config.deleteSessionDataOnLogout) {
                        client.onStateChanged(function (state) {
                            if (state === 'UNPAIRED') {
                                var sessionjsonpath_1 = ((config === null || config === void 0 ? void 0 : config.sessionDataPath) && (config === null || config === void 0 ? void 0 : config.sessionDataPath.includes('.data.json'))) ? path.join(path.resolve(process.cwd(), (config === null || config === void 0 ? void 0 : config.sessionDataPath) || '')) : path.join(path.resolve(process.cwd(), (config === null || config === void 0 ? void 0 : config.sessionDataPath) || ''), (sessionId || 'session') + ".data.json");
                                if (fs.existsSync(sessionjsonpath_1))
                                    fs.unlinkSync(sessionjsonpath_1);
                            }
                        });
                    }
                ...
                case 39:
                    me = (_d.sent()).me;
                    if (!(config === null || config === void 0 ? void 0 : config.licenseKey)) return [3, 49];
                    if (!!axios) return [3, 41];
                    return [4, Promise.resolve().then(function () { return __importStar(require('axios')); })];
                case 40:
                    axios = _d.sent();
                    _d.label = 41;
                case 41:
                    ...
                    return [4, axios.post(pkg.licenseCheckUrl, __assign({ key: config.licenseKey, number: me._serialized }, debugInfo))];
                case 42:
                    data = (_d.sent()).data;
                    if (!data) return [3, 47];
                ...
                case 43:
                    l_success = _d.sent();
                    if (!!l_success) return [3, 45];
                    return [4, waPage.evaluate('window.launchError')];
                case 44:
                    l_err = _d.sent();
                    return [3, 46];
                case 45:
                ...
                case 52:
                    _d.sent();
                    return [4, create(config)];
                case 53: return [2, _d.sent()];
                case 54: return [3, 57];
                case 55:
                    error_1 = _d.sent();
...
var kill = function (p) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!p) return [3, 6];
                return [4, (p === null || p === void 0 ? void 0 : p.browser())];
            case 1:
                browser = _a.sent();
                if (!browser)
                    return [2];
                ...
                if (!pid)
                    return [2];
                if (!!(p === null || p === void 0 ? void 0 : p.isClosed())) return [3, 3];
                return [4, p.close()];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
                ...
                return [4, browser.close().catch(function () { })];
            case 4:
                _a.sent();
                _a.label = 5;
            case 5:
