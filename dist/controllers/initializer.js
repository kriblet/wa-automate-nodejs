...
function create(_sessionId, config, customUserAgent) {
    return __awaiter(this, void 0, void 0, function () {
        var START_TIME, waPage, notifier, sessionId, prettyFont, popupaddr, spinner, throwOnError_1, PAGE_UA, BROWSER_VERSION, WA_AUTOMATE_VERSION, WA_VERSION, canInjectEarly, debugInfo, authRace, authenticated, outOfReach, autoRefresh_1, qrLogSkip_1, qrLoop_1, qrSpin, race, result, pre, VALID_SESSION, localStorage_1, _a, _b, sessionjsonpath, sessionData, sdB64, pureWAPI, LAUNCH_TIME_MS, data, client, me, data, error_1;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 29:
                    ...
                    if (!(config === null || config === void 0 ? void 0 : config.hostNotificationLang)) return [3, 31];
                    return [4, waPage.evaluate("window.hostlang=\"" + config.hostNotificationLang + "\"")];
                case 30:
                    _c.sent();
                    _c.label = 31;
                case 31:
                    if (!!(config === null || config === void 0 ? void 0 : config.skipPatches)) return [3, 34];
                ...
                case 35:
                    me = (_c.sent()).me;
                    if (!(config === null || config === void 0 ? void 0 : config.licenseKey)) return [3, 39];
