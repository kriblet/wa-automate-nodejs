...
var io, express, app, open = require('open'), getPort = require('get-port'), url = require('url'), gClient, serverSockets = {}, PORT, server, currentQrCodes = {
...
var setUpApp = function () {
    ...
    app.get('/qr', function (req, res, next) {
        ...
        var sessionId = parsedUrl.sessionId;
...
function popup(config) {
    return __awaiter(this, void 0, void 0, function () {
        var preferredPort, _a;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    setUpApp();
                    preferredPort = config.popup;
                    events_1.ev.on('**', function (data, sessionId, namespace) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (namespace.includes("sessionData") || namespace.includes("DebugInfo"))
                                        return [2];
                                    if (!gClient) return [3, 3];
                                    return [4, gClient.send({ data: data, sessionId: sessionId, namespace: namespace })];
                                case 1:
                                    _a.sent();
                                    if (!((data === null || data === void 0 ? void 0 : data.includes) && (data === null || data === void 0 ? void 0 : data.includes("ready for account")))) return [3, 3];
                                    return [4, gClient.send({ data: config === null || config === void 0 ? void 0 : config.apiHost, sessionId: sessionId, namespace: "ready" })];
                                case 2:
                                    _a.sent();
                                    _a.label = 3;
                                case 3:
                                    ...
                                    if (!((data === null || data === void 0 ? void 0 : data.includes) && (data === null || data === void 0 ? void 0 : data.includes("ready for account")))) return [3, 5];
                                    return [4, exports.closeHttp()];
                                case 4:
                                    _a.sent();
                                    _a.label = 5;
                                case 5: return [2];
                    ...
                    return [4, getPort({ host: 'localhost', port: typeof preferredPort == 'number' ? [preferredPort, 7000, 7001, 7002] : [7000, 7001, 7002] })];
                case 1:
                    PORT = _b.sent();
                    ...
                    server.listen(PORT);
                    if (!!(config === null || config === void 0 ? void 0 : config.inDocker)) return [3, 3];
                    return [4, open("http://localhost:" + PORT + ((config === null || config === void 0 ? void 0 : config.qrPopUpOnly) ? "/qr" : ""), { app: ['google chrome', '--incognito'], allowNonzeroExitCode: true }).catch(function () { })];
                case 2:
                    _b.sent();
                    return [3, 4];
                case 3: return [2, "NA"];
                case 4:
                    if (!(config === null || config === void 0 ? void 0 : config.qrPopUpOnly)) return [3, 5];
                    _a = "http://localhost:" + PORT + "/qr";
                    return [3, 7];
                case 5: return [4, new Promise(function (resolve) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, new Promise(function (resolve) { return server.close(resolve); })];
